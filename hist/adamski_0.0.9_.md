...
- File SHA256: `F*95480B08E85EF658ED6566BA3A3C587D6E7F51C1633DB78C75D365269575BA68` for this version
- Content SHA256: `C*070A0AC7C0A3620AA4D7BC0FCAB58F39813AB1C9D2D2707A94FD66A6C341374A` for this version
  
---
 
# The `Adamski` package, version: `0.0.9`;
...
1. [`%derive_basetype_records()` macro ](#derivebasetyperecords-macro-1 )
2. [`%derive_locf_records()` macro ](#derivelocfrecords-macro-2 )
3. [`%derive_var_age_years()` macro ](#derivevarageyears-macro-3 )
4. [`%derive_var_analysis_ratio()` macro ](#derivevaranalysisratio-macro-4 )
5. [`%derive_var_base()` macro ](#derivevarbase-macro-5 )
6. [`%derive_var_chg()` macro ](#derivevarchg-macro-6 )
7. [`%derive_var_extreme_flag()` macro ](#derivevarextremeflag-macro-7 )
8. [`%derive_var_merged_exist_flag()` macro ](#derivevarmergedexistflag-macro-8 )
9. [`%derive_var_obs_number()` macro ](#derivevarobsnumber-macro-9 )
10. [`%derive_var_pchg()` macro ](#derivevarpchg-macro-10 )
11. [`%derive_var_trtdurd()` macro ](#derivevartrtdurd-macro-11 )
12. [`%derive_vars_aage()` macro ](#derivevarsaage-macro-12 )
13. [`%derive_vars_cat()` macro ](#derivevarscat-macro-13 )
14. [`%derive_vars_duration()` macro ](#derivevarsduration-macro-14 )
15. [`%derive_vars_dy()` macro ](#derivevarsdy-macro-15 )
16. [`%derive_vars_joined()` macro ](#derivevarsjoined-macro-16 )
  
 
17. [License note](#license)
  
---
 
## `%derive_basetype_records()` macro <a name="derivebasetyperecords-macro-1"></a> ######
...
## `%derive_locf_records()` macro <a name="derivelocfrecords-macro-2"></a> ######
...
## `%derive_var_age_years()` macro <a name="derivevarageyears-macro-3"></a> ######
...
## `%derive_var_analysis_ratio()` macro <a name="derivevaranalysisratio-macro-4"></a> ######
...
## `%derive_var_base()` macro <a name="derivevarbase-macro-5"></a> ######
...
## `%derive_var_chg()` macro <a name="derivevarchg-macro-6"></a> ######
...
## `%derive_var_extreme_flag()` macro <a name="derivevarextremeflag-macro-7"></a> ######
...
## `%derive_var_merged_exist_flag()` macro <a name="derivevarmergedexistflag-macro-8"></a> ######
...
## `%derive_var_obs_number()` macro <a name="derivevarobsnumber-macro-9"></a> ######
...
## `%derive_var_pchg()` macro <a name="derivevarpchg-macro-10"></a> ######
...
## `%derive_var_trtdurd()` macro <a name="derivevartrtdurd-macro-11"></a> ######
/*
### Macro:
    %derive_var_trtdurd
...
## `%derive_vars_aage()` macro <a name="derivevarsaage-macro-12"></a> ######
...
## `%derive_vars_cat()` macro <a name="derivevarscat-macro-13"></a> ######
...
## `%derive_vars_duration()` macro <a name="derivevarsduration-macro-14"></a> ######
...
## `%derive_vars_dy()` macro <a name="derivevarsdy-macro-15"></a> ######
...
## `%derive_vars_joined()` macro <a name="derivevarsjoined-macro-16"></a> ######
### Macro:
    %derive_vars_joined
