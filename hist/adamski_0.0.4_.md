...
- File SHA256: `F*B2037F5369373220BB711BEDE53AADABEAAED45B8488CB23791A3B660686E7C7` for this version
- Content SHA256: `C*78A07193C58D6D83A8CF215032AA6EC3E0CCE1E68C16A016B16A487A0F4F8367` for this version
  
---
 
# The `Adamski` package, version: `0.0.4`;
...
1. [`%derive_var_age_years()` macro ](#derivevarageyears-macro-1 )
2. [`%derive_var_merged_exist_flag()` macro ](#derivevarmergedexistflag-macro-2 )
3. [`%derive_vars_duration()` macro ](#derivevarsduration-macro-3 )
4. [`%derive_vars_dy()` macro ](#derivevarsdy-macro-4 )
...
## `%derive_var_age_years()` macro <a name="derivevarageyears-macro-1"></a> ######
...
## `%derive_var_merged_exist_flag()` macro <a name="derivevarmergedexistflag-macro-2"></a> ######
...
## `%derive_vars_duration()` macro <a name="derivevarsduration-macro-3"></a> ######
...
## `%derive_vars_dy()` macro <a name="derivevarsdy-macro-4"></a> ######
