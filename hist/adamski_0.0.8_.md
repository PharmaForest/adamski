...
- File SHA256: `F*79606D7006393EF276436FED8365D4477A231FCA2D825A4F8090C3DB7553830E` for this version
- Content SHA256: `C*332110882C85BB370D4C2B4F833D9E0F95742DF803A145CB90669B4250E04DD0` for this version
  
---
 
# The `Adamski` package, version: `0.0.8`;
...
4. [`%derive_var_base()` macro ](#derivevarbase-macro-4 )
5. [`%derive_var_chg()` macro ](#derivevarchg-macro-5 )
6. [`%derive_var_merged_exist_flag()` macro ](#derivevarmergedexistflag-macro-6 )
7. [`%derive_var_obs_number()` macro ](#derivevarobsnumber-macro-7 )
8. [`%derive_vars_aage()` macro ](#derivevarsaage-macro-8 )
9. [`%derive_vars_cat()` macro ](#derivevarscat-macro-9 )
10. [`%derive_vars_duration()` macro ](#derivevarsduration-macro-10 )
11. [`%derive_vars_dy()` macro ](#derivevarsdy-macro-11 )
12. [`%derive_vars_joined()` macro ](#derivevarsjoined-macro-12 )
...
## `%derive_var_base()` macro <a name="derivevarbase-macro-4"></a> ######
...
## `%derive_var_chg()` macro <a name="derivevarchg-macro-5"></a> ######
...
## `%derive_var_merged_exist_flag()` macro <a name="derivevarmergedexistflag-macro-6"></a> ######
...
## `%derive_var_obs_number()` macro <a name="derivevarobsnumber-macro-7"></a> ######
...
## `%derive_vars_aage()` macro <a name="derivevarsaage-macro-8"></a> ######
...
## `%derive_vars_cat()` macro <a name="derivevarscat-macro-9"></a> ######
...
## `%derive_vars_duration()` macro <a name="derivevarsduration-macro-10"></a> ######
...
## `%derive_vars_dy()` macro <a name="derivevarsdy-macro-11"></a> ######
...
## `%derive_vars_joined()` macro <a name="derivevarsjoined-macro-12"></a> ######
### Macro:
    %derive_vars_joined
