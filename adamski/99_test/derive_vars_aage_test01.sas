...
### Purpose:
- Unit test for the %derive_vars_aage() macro wtih type=duration

### Expected result:  
- dataset test with AAGE calculated by type=duration will be created  
...
%mp_assertdataset(
  ...
  desc=(%nrstr(%derive_vars_aage))[test01] Compare expected and test results for case with type=duration, 	/* description */
