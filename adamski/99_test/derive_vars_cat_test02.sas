...
### Purpose:
- Unit test for the %derive_vars_cat() macro in case with by_vars
...
01-701-1015 Weight 53.98 <=70_kg 2
01-701-1023 Height 162.56 >160_cm 1
01-701-1023 Weight . . .
01-701-1028 Height . . .
01-701-1028 Weight . . .
01-701-1033 Height 175.26 >160_cm 1
01-701-1033 Weight 88.45 >70_kg 1
;
run;

/*output by the macro*/
data definition;
    length VSTEST $10 CONDITION $50 AVALCAT1 $20;
    infile datalines dlm='|' dsd truncover;
    input VSTEST $ CONDITION $ AVALCAT1 $ AVALCA1N ;
datalines;
Height|AVAL>160|>160_cm|1
Height|AVAL ne . and AVAL<=160|<=160_cm|2
Weight|AVAL>70|>70_kg|1
Weight|AVAL ne . and AVAL<=70|<=70_kg|2
;
run;
