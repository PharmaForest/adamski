...
### Purpose:
- Unit test for the %derive_var_pchg() macro  
...
data advs_exp;
  length USUBJID $3 PARAMCD $6 ABLFL $1;
  input USUBJID $ PARAMCD $ AVAL ABLFL $ BASE PCHG;
datalines;
P01 WEIGHT 80.0  Y  80.0 0
P01 WEIGHT 80.8  .  80.0 1.0
P01 WEIGHT 81.4  .  80.0 1.75
P02 WEIGHT 75.3  Y  75.3 0
P02 WEIGHT 76.0  .  75.3 0.9296148738
;
run;
...
%mp_assertdataset(
  ...
  desc		= (%nrstr(%derive_var_pchg))[test01] Compare expected and test results, 	/* description */
